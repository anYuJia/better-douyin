...
抖音内容下载、预览与本地归档工具。公开源码保留前端 UI、mock bridge 和协作边界；完整可用应用请下载 Releases。
...
better-douyin 是 Python 版抖音桌面工具，面向内容预览、本地归档、下载管理和桌面端使用体验。
...
以下为完整发行版能力。公开源码仅保留 UI、mock bridge 与协作边界，用于体验界面和二次开发，不包含真实平台连接器。
...
- Python 版支持桌面窗口模式，也支持浏览器访问和无界面 / 服务模式运行。
...
<table>
  <tr>
    <td width="50%" align="center">
      <a href="img/preview/screen-user-detail-crop.png"><img src="img/preview/screen-user-detail-crop.png" width="100%" alt="用户主页与作品列表"></a>
      <br><strong>用户主页 / 作品列表</strong>
    </td>
    <td width="50%" align="center">
      <a href="img/preview/screen-recommended-crop.png"><img src="img/preview/screen-recommended-crop.png" width="100%" alt="推荐视频流"></a>
      <br><strong>推荐视频流</strong>
    </td>
  </tr>
  <tr>
    <td width="50%" align="center">
      <a href="img/preview/screen-downloads-crop.png"><img src="img/preview/screen-downloads-crop.png" width="100%" alt="我的下载"></a>
      <br><strong>我的下载 / 本地文件</strong>
    </td>
    <td width="50%" align="center">
      <a href="img/preview/screen-notices-crop.png"><img src="img/preview/screen-notices-crop.png" width="100%" alt="通知中心"></a>
      <br><strong>通知中心</strong>
    </td>
  </tr>
  <tr>
    <td width="50%" align="center">
      <a href="img/preview/screen-friends-crop.png"><img src="img/preview/screen-friends-crop.png" width="100%" alt="好友私信"></a>
      <br><strong>好友 / 私信</strong>
    </td>
    <td width="50%" align="center">
      <a href="img/preview/screen-automation-crop.png"><img src="img/preview/screen-automation-crop.png" width="100%" alt="自动监控设置"></a>
      <br><strong>自动监控设置</strong>
    </td>
  </tr>
  <tr>
    <td colspan="2" align="center">
      <a href="img/preview/screen-player.png"><img src="img/preview/screen-player.png" width="100%" alt="沉浸式播放器"></a>
