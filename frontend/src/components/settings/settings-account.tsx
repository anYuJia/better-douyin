                ...
                <div className="flex items-center gap-1">
                  {isExpired ? (
                    <Button
                      ...
                      className="h-7 rounded-[6px] text-[0.72rem] font-semibold px-2 hover:bg-danger/10 hover:text-danger text-danger cursor-pointer animate-pulse disabled:cursor-not-allowed disabled:opacity-50"
                    >
                      重新登录
                    </Button>
                  ) : (
                    !isActive && (
                      <Button
                        ...
                        disabled={actionPending}
                        className="h-7 rounded-[6px] text-[0.72rem] font-semibold px-2 hover:bg-accent/10 hover:text-accent cursor-pointer disabled:cursor-not-allowed disabled:opacity-50"
                      >
                        切换
                      </Button>
                    )
                  ...
                  <Button
                    ...
                    className="w-7 h-7 rounded-[6px] text-text-muted hover:text-danger hover:bg-danger/10 cursor-pointer disabled:cursor-not-allowed disabled:opacity-50"
                  >
